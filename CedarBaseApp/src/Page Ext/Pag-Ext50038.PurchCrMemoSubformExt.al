pageextension 50038 "Purch Cr. Memo Subform Ext" extends "Purch. Cr. Memo Subform"
{
    ContextSensitiveHelpPage = 'purchasing-how-process-purchase-returns-cancellations';
