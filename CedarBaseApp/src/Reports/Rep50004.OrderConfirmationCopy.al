report 50004 "Order Confirmation_Copy"
{
    DefaultLayout = RDLC;
    RDLCLayout = './layout/Order Conf.rdl';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(DevisionPhNo; Division."Phone No.")
                    {
                        IncludeCaption = false;
                    }
                    column(DevisionVATRegNo; Division."VAT Registration No.")
                    {
                    }
                    ...
                    column(DivisionBankAccNo; Division."Bank Account No.")
                    {
                    }
                    ...
                    column(SellToemail; "Sales Header"."Sell-to E-Mail")
                    {
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(UnitPrice_SalesLine; Format("Sales Line"."Unit Price" / "Sales Line"."Qty. per Unit of Measure") + ' ' + itemRec."Base Unit of Measure")
                        {
            ...
            if "Sales Header".FindSet then
                repeat
                    ...
                    if "Sales Header"."Bill-to Contact No." <> '' then
                        SegManagement.LogDocument(InteractionLogEntryDocumentType::"Sales Ord. Cnfrmn.".AsInteger(), "Sales Header"."No.", "Sales Header"."Doc. No. Occurrence",
